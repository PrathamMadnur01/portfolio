      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 w-96 h-96 bg-emerald-500/20 rounded-full blur-3xl -z-10 animate-pulse" style={{ animationDelay: '2s' }}></div>
          </motion.div>
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.h2 
            ...
            viewport={{ once: true }}
            className="text-5xl font-bold mb-8 font-mono bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent"
          >
            {'<About />'}
          </motion.h2>
          <motion.div
      ...
      <section id="projects" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <motion.h2 
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="text-5xl font-bold mb-12 font-mono bg-gradient-to-r from-purple-400 to-emerald-400 bg-clip-text text-transparent"
          >
            {'<Projects />'}
          </motion.h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.h2 
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-5xl font-bold mb-4 font-mono bg-gradient-to-r from-purple-400 via-cyan-400 to-emerald-400 bg-clip-text text-transparent"
            >
              {'<Contact />'}
            </motion.h2>
            <motion.p 
            ...
            >
              <motion.div whileHover={{ scale: 1.1, rotate: 5 }} whileTap={{ scale: 0.95 }}>
                <Button className="bg-gradient-to-r from-purple-500 to-cyan-500 hover:from-purple-600 hover:to-cyan-600 text-white dark:text-white shadow-lg shadow-purple-500/50" asChild>
